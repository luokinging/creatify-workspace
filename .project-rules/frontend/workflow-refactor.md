...
### 2.2 数据获取设计
- **工具复用：数据获取优先使用 `PaginatedQueryManager`、`createAutoKeyMiniQueryClient` 等工具类，避免手动管理 loading/error 状态**
- 参考文档：`.project-rules/frontend/utility-managers.md`
