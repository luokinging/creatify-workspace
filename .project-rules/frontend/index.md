...
### 2. [MVC 架构模式 (MVC Architecture)](./mvc-architecture.md) ⭐
...
### 7. [反模式 (Anti-Patterns)](./anti-patterns.md) ⭐

**前端开发避坑指南**

- **核心内容：** 避免滥用 Hooks (useMemo, useCallback, useEffect)，避免组件逻辑复杂化
- **关键原则：** 保持组件简单，逻辑下沉到 Manager，不要过早优化
- **适用场景：** 所有前端开发任务，Code Review 必读
